...
if (sheetName.includes("Males-25 M WALK") || sheetName.includes("Males-25 M DEVICE") || sheetName.includes("Males-25 M WC-ASSISTED") || sheetName.includes("Males-25 M MANUAL WC") || sheetName.includes("Males-30 M SLALOM") || sheetName.includes("Males-50 MD") || sheetName.includes("Males-50 M WC") || sheetName.includes("Males-100 MD") || sheetName.includes("Females-25 M WALK") || sheetName.includes("Females-25 M Device") || sheetName.includes("Females-25 M WC-ASSISTED") || sheetName.includes("Females-25 M MANUAL WC") || sheetName.includes("Females-30 M SLALOM") || sheetName.includes("Females-50 MD") || sheetName.includes("Females-50 M WC") || sheetName.includes("Females-100 MD")) {
    return columnMappingOption1; // Return columns for first sheet type
  } else if (sheetName.includes("Males-TURBO JAV") || sheetName.includes("Males-TENNIS BALL THROW") || sheetName.includes("Males-SOFTBALL") || sheetName.includes("Males-RUNNING LJ") || sheetName.includes("Males-FOAM TURBOJAV") || sheetName.includes("Males-BEAN BAG THROW") || sheetName.includes("Females-TURBO JAV") || sheetName.includes("Females-TENNIS BALL THROW") || sheetName.includes("Females-SOFTBALL") || sheetName.includes("Females-RUNNING LJ") || sheetName.includes("Females-FOAM TURBO JAV") || sheetName.includes("Females-BEAN BAG THROW")) {
